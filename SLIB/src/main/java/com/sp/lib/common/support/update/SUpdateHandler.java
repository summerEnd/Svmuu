...
public class SUpdateHandler extends UpdateHandler {

    Context context;
    private ProgressDialog dialog;
    private Downloader downloader;

    public SUpdateHandler(Context context) {
    ...
    public void doUpdate() {
        super.doUpdate();
        long id = downloader.downloadWithNotification(getUrl(), null, null, "hello", "hello");
