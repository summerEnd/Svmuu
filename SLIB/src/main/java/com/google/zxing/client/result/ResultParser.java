...
public abstract class ResultParser {
   ...
   * of information (email, URL, etc.) and return a {@link com.google.zxing.client.result.ParsedResult} encapsulating
   * the result of parsing.
   *
   * @param theResult the raw {@link Result} to parse
   * @return {@link com.google.zxing.client.result.ParsedResult} encapsulating the parsing result
   */
