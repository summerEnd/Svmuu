...
public class TNFragment extends BaseFragment {
    ...
    private void initialize() {
        ...
        introduce = (CircleItem) findViewById(R.id.introduce);
        ...
        changeGroup = (CircleItem) findViewById(R.id.changeGroup);
